...
// Split the farmAnimals string into an array and remove the horse and chicken
const [cow, , sheep, pig] = farmAnimals.split(' ');

// Destructure the remaining animals to assign to the color variables
...
// Destructure to get song2, song4, nestedJob, and nestedPartner
const {
  album: {
    theMuppetMovie: {
      song2,
